...
const CreatePoll = ({ handleCancel1 }) => {
    ...
    const items = [
        {
          label: `Publish as ${userData.username}`,
          key: '1',
        },
        {
          label: 'Publish as anonymous user',
          key: '2',
        }
      ];
  ...
  return (
    <>
        <div className='mb-5 flex justify-between'>
            ...
            >
                <p style={{borderBottomWidth: '1px'}} className='cursor-pointer' onClick={(e) => console.log(e.target.value)}>
          ...
          <form>
            ...
            {val.map((data, i)=>{
                return(
                    <div className='flex items-center'>
                        <input className=' mt-3 mb-7 border-post font-normal px-2 w-full' placeholder={'Choice ' +(i+1)} value={data} onChange={e=>handleChange(e,i)} />
                        <button style={{color: 'darkred'}} className='w-9 h-9' onClick={(e)=>handleDelete(e,i)}>X</button>
                    </div>
                )
            })}
            ...
            {/* <Dropdown
                ...
                trigger={['click']}
            >
                <p style={{borderBottomWidth: '1px', width: 'fit-content'}} className='cursor-pointer'>
          ...
          <div className='flex justify-between w-full items-center'>
            <div className=' flex '>
                ...
                <input type="file" id="upload1" style={{ display: 'none' }} onChange={handleImageUpload} />
            ...
            <button style={{color: 'white'}} className='bg-gradient-to-r from-buttonRight to-gradientRight py-3 px-7 rounded-xl font-semibold'>POST</button>
          </div>
    </>
  )
}
