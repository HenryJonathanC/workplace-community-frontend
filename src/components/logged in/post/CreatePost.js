  ...
  return (
    <>
        <div className='mb-5 flex justify-between'>
          ...
          <form>
            <input className=' mt-3 mb-7 border-post font-normal px-2 w-full' type='text' placeholder='Add you post title' />
            <textarea rows={4} className='resize-none mt-3 mb-7 border-post w-full font-normal px-2' placeholder='What is in your mind?'></textarea>
